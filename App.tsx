          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className="flex items-center gap-2">
                <span className="text-xs font-mono text-white bg-teal-600/80 px-2 py-0.5 rounded border border-teal-500 shadow-sm">
                  Frontend v5.6
                </span>
              </div>
            </div>
          ...
          <div className="space-y-12 animate-fade-in">
            <div className="text-center max-w-2xl mx-auto space-y-4">
              ...
              <p className="text-slate-400 text-lg">
                ...
                아래 <span className="text-teal-400 font-semibold">5단계 순서(Step-by-Step)</span>를 따라 안전한 연결 구조를 구축하세요.
              </p>
            </div>
